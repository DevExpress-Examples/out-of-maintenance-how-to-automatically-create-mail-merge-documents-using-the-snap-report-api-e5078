...
Namespace MailMergeServer
    ...
    Friend Class Program
        ...
        Const defaultTemplateFileName As String = "template.snx"

        Const defaultOutputFileName As String = "mailmerge.rtf"
        ...
        Shared Sub Main(ByVal args As String())
            ...
            If Not File.Exists(templateFileName) Then Throw New FileNotFoundException("Template file not found", templateFileName)
...
'#Region "#ServerCode"
            Dim server As SnapDocumentServer = New SnapDocumentServer()
...
'#Region "#RecordFinished"
        Private Shared Sub server_SnapMailMergeRecordFinished(ByVal sender As Object, ByVal e As SnapMailMergeRecordFinishedEventArgs)
            If e.RecordIndex = 3 Then e.RecordDocument.AppendText("This is the third data record." & Microsoft.VisualBasic.Constants.vbCrLf)
        End Sub
...
'#End Region  ' #RecordStarted
        Private Shared Function CreateDataSource() As Object
            ...
            Dim categories As CategoriesTableAdapter = New CategoriesTableAdapter()
